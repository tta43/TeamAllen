                     ...
                     int       nCmdShow)
{
	...
	// DInput
	Engine::CInputClass* pInput = Engine::Get_DirectInput();

	if (!pInput->Initialize(hInstance, g_hWnd, WINCX, WINCY))
	{
		MessageBox(g_hWnd, L"Could not initialize the input object.", L"Error", MB_OK);
		return false;
	}
